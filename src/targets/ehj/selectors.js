const SELECTORS = {
  login: {
    ...
    submit:
      "app-general-login app-login form button[type='submit'], app-general-login app-login form div > button",
    submitCandidates: [
      "app-general-login app-login form button[type='submit']",
      "button.login-btn[type='submit']",
      "app-general-login app-login form div > button",
      "button[type='submit']",
    ],
    recaptchaResponse: "#g-recaptcha-response",
    recaptchaTokenFields: [
  ...
  loginOtp: {
    firstDigit:
      "#OtpValue, input[name='OtpValue'], input[formcontrolname='OtpValue'], ng-otp-input input.otp-input, ng-otp-input input[maxlength='1']",
    digitInputs:
      "ng-otp-input input.otp-input, ng-otp-input input[maxlength='1']",
    submitCandidates: [
      "app-general-login app-login form button[type='submit']",
      "button.login-btn[type='submit']",
      "app-general-login app-login form div > button",
    ...
    label:
      "#login > app-login > div.login-otp g-otp-built-in-component form p, app-general-login app-login form p",
    h1: "#login > app-login > div.login-otp g-otp-built-in-component form h3, app-general-login app-login form h3",
  },
  dataEntry: {
    automaticScan:
    ...
    // Prefer text-based click in data-entry-method.js; keep CSS fallback without Angular IDs.
    confirmScanButton:
      "app-data-entry-method p-dialog .p-dialog-footer button.btn-primary",
    nextButton:
      "app-data-entry-method > action-btns button, app-data-entry-method action-btns button",
  ...
  identityAndResidence: {
    ...
    // Selector for residence ID number input field (used to write passport number when residence image is detected)
    residenceIdNumber:
      "#content > div > app-applicant-add > app-identity-and-residence > form > div.row.ng-star-inserted > div > app-main-card > div > div.body.collapse.show > div > div:nth-child(2) > g-input-text > div > div.input-text-wrapper-class > input",
